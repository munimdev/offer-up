      ...
      <div>
        <div className="container py-20">
          <div>
            <div className="[&>*]:mt-6">
              <h2>
                <strong className="text-3xl">Terms and Conditions</strong>
              </h2>
              <p>Welcome to Bargainex.com!</p>
              <p>
                These terms and conditions outline the rules and regulations for
                the use of Bargain Exchange LLC's Website, located at
                https://bargainex.com.
              </p>
              <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Bargainex.com if you do not
              ...
              <p>
                We employ the use of cookies. By accessing Bargainex.com, you
                agreed to use cookies in agreement with the Bargain Exchange
              ...
              <p>
                Unless otherwise stated, Bargain Exchange LLC and/or its
                licensors own the intellectual property rights for all material
                on Bargainex.com. All intellectual property rights are reserved.
                You may access this from Bargainex.com for your own personal use
                subjected to restrictions set in these terms and conditions.
              </p>
              <p>You must not:</p>
              <ul className="list-disc list-inside">
                <li>Republish material from Bargainex.com</li>
                <li>Sell, rent or sub-license material from Bargainex.com</li>
                <li>
                  Reproduce, duplicate or copy material from Bargainex.com
                </li>
                <li>Redistribute content from Bargainex.com</li>
              </ul>
              <p>
              ...
              <p>
                ...
                website. Bargain Exchange LLC does not filter, edit, publish or
                review Comments prior to their presence on the website. Comments
                do not reflect the views and opinions of Bargain Exchange
                ...
                extent permitted by applicable laws, Bargain Exchange LLC shall
                not be liable for the Comments or for any liability, damages or
                expenses caused and/or suffered as a result of any use of and/or
                posting of and/or appearance of the Comments on this website.
              </p>
              <p>
                Bargain Exchange LLC reserves the right to monitor all Comments
              ...
              <p>
                You hereby grant Bargain Exchange LLC a non-exclusive license to
              ...
              <p>
                ...
                of Bargain Exchange LLC; and (d) the link is in the context of
              ...
              <p>
                ...
                by sending an e-mail to Bargain Exchange LLC. Please include
              ...
              <p>
                No use of Bargain Exchange LLC's logo or other artwork will be
