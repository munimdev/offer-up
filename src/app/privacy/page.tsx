  ...
  return (
    <div className="translations-content-container">
      <div className="container">
        <div
          className="tab-content translations-content-item en visible flex flex-col gap-y-8 py-20"
          id="en"
        >
          ...
          <ul className="list-disc list-outside">
            ...
            <li>
              <p>
                ...
                {"We"}, {"Us"} or {"Our"} in this Agreement) refers to Bargain
                Exchange LLC, 30 N Gould st, STE R Sheridan, WY82801.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to BargainEx.com, accessible
                from{" "}
                <a
                  href="https://bargainex.com/"
